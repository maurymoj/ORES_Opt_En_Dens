function stop = pswplotmeanx(optimValues,state)
...
switch state
    case 'init'
        ...
        for i = 1:nplot % Set up axes for plot
            subplot(nplot,1,i);
            tag = sprintf('psoplotmean_var_%g',i); % Set a tag for the subplot
    ...
    case 'iter'
        ...
        for i = 1:nplot
            ...
            imean = mean(optimValues.swarm(:,i));
            tag = sprintf('psoplotmean_var_%g',i);
            ...
            newY = [ydata imean]; % Add the new value
